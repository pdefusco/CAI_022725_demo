...
#{"dataframe_split": {"columns": ["bank_account_balance", "credit_card_balance", "fraud_trx", "mortgage_balance", "primary_loan_balance", "savings_account_balance", "sec_savings_account_balance", "total_est_nworth", "primary_loan_balance", "secondary_loan_balance", "uni_loan_balance", "longitude", "latitude", "transaction_amount", "trx_dist_from_home", "ADDRESS_LATITUDE", "ADDRESS_LONGITUDE"], "data":[[35.5, 20000.5, 3900.5, 14000.5, 2944.5, 3400.5, 12000.5, 29000.5, 1300.5, 15000.5, 10000.5, 2000.5, 90.5, 120.5, 201.5, 110.5, 90.5]]}}
